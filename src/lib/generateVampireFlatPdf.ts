...
// fields at all, purely a static snapshot. Mirrors generateMageFlatPdf.ts's approach; see that
// file for why cards are captured and placed individually rather than sliced as one tall image.
export async function generateVampireFlatPdf(sheetElement: HTMLElement): Promise<Uint8Array> {
