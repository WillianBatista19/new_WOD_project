...
const ALL_TOPICS: ReferenceTopic[] = ['traditions', 'spheres', 'essences', 'arete', 'paradox']

export default function QuickReferenceSidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  return (
    <aside
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5">
        <QuickReferenceContent topics={ALL_TOPICS} />
      </div>
    </aside>
  )
}
