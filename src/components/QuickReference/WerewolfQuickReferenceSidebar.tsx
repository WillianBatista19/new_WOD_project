...
const ALL_TOPICS: WerewolfReferenceTopic[] = ['tribes', 'auspices', 'rage', 'harmony', 'forms']

export default function WerewolfQuickReferenceSidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  return (
    <aside
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5">
        <WerewolfQuickReferenceContent topics={ALL_TOPICS} />
      </div>
    </aside>
  )
}
